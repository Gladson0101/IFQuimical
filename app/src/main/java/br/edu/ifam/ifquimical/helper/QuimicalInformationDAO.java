...
public class QuimicalInformationDAO implements IQuimicalInformationDAO {

    private SQLiteDatabase write;
    private SQLiteDatabase read;

    /**
     * Construtor padrão para DAO
     *
     * @param context
     */
    public QuimicalInformationDAO(Context context) {
    ...
    public boolean save(QuimicalInformation qi) {
        ...
        try {
            write.insert(DBHelper.TABLE_QUIMICAL_INFORMATION, null, cv);
        } catch (Exception e) {
            return false;
        }
    ...
    public boolean delete(QuimicalInformation qi) {
        ...
        try {
            ...
            write.delete(DBHelper.TABLE_QUIMICAL_INFORMATION, "name=?", args);
        } catch (Exception e) {
            return false;
        }
